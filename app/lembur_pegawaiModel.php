...
class lembur_pegawaiModel extends Model
{
	...
	protected $fillable=array('id','kode_lembur_id','lembur_pegawai','jumlah_jam','pegawai_id');
	protected $visible=array('id','kode_lembur_id','lembur_pegawai','jumlah_jam','pegawai_id');
